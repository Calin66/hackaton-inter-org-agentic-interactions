...
SYSTEM = SystemMessage(
    content=(
        ...
        "To make a valid claim, the following information is required: full name, patient SSN, diagnose, and procedures.\n"
        "Always remind the doctor of these required fields for creating a new claim when starting a conversation or when information is missing.\n"
        "If not all required information is provided, clearly tell the doctor which fields are missing and ask for them.\n"
